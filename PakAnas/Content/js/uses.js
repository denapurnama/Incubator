...
function DataTableAjaxErrHandler(xhr, status, thrown) {
    if (status == 'parsererror') {
        pesanErr("Batas waktu habis,<br/> harap <a href=\"/Login\">login</a> kembali");
    } else if (status == 'error' || thrown == null) {
        pesanErr("Tidak terhubung,<br/>mungkin karena<br/>ada gangguan pada penyedia data");
    } else {
        pesanErr("Gagal ambil data karena: <br/>" + status + " " + thrown);
    }
}
